...
class StatisticsBuilder:
    ...
    @classmethod
    def build_benchmark(cls, benchmark_symbol: BenchmarkSymbol, starting_capital: float, start_date: Date, end_date: Date) -> StatisticsResults:
        """
        Builds the statistics and returns the results of benchmark.
        """   
        benchmark_performance = BenchmarkPerformance(benchmark_symbol, starting_capital, start_date, end_date)
    ...
    def build_strategy(
        ...
        """
        strategy_performance: StrategyPerformance = StrategyPerformance(trades, benchmark_returns, starting_capital, start_date, end_date)
