...
class DailyStatistics():
    ...
    def __init__(self) -> None:
        ...
        self.profit_loss_ratio: float = 0 # The ratio of the average win rate to the average loss rate.
        self.win_rate: float = 0 # The ratio of the number of winnig trades to the total number of trades.
