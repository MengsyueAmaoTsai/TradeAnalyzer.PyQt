...
class InstrumentTable(QTableWidget):
    ...
    def add_instrument(self, instrument: Instrument) -> None:
        ...
        exchange_combo.setCurrentIndex(
            Exchange.SUPPORTS_EXCHANGES.index(instrument.exchange.id)
        )
        ...
        instrument_type_combo.setCurrentIndex(
            list(InstrumentType).index(instrument.type)
        )
