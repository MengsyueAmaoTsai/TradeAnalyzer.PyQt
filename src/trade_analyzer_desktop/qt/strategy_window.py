...
class StrategyWindow(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        self.__strategy_table.itemSelectionChanged.connect(self.on_strategy_table_item_section_changed)
        self.__strategy_table.backtest_report_uploaded.connect(self.on_backtest_report_uploaded)
